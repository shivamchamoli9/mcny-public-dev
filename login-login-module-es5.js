...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  function srcAppLoginLoginServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _core_constants_api_endpoints__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      _createClass(LoginComponent, [{
        ...
        value: function ngOnInit() {
          this.loginForm = this.fb.group({
            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern("^[a-zA-Z0-9][-a-zA-Z0-9._]+@([- a-z0-9]+[.])+[a-z]{2,5}$")])),
            password: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern("(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[$@$!%*?&])[A-Za-zd$@$!%*?&].{8,}"),, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]))
          });
          ...
          if (this.loginForm.valid) {
            this.loginService.loginUser(this.loginForm.value).subscribe(function (data) {
              if (data.status === "success") {
                _this.storeUserInfo(data.data).then(function (result) {
        ...
        key: "storeUserInfo",
        value: function storeUserInfo(data) {
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return localStorage.setItem("mcny_user", JSON.stringify(data));
